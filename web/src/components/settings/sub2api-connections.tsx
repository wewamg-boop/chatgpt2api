      ...
      <Card className="rounded-2xl border-white/80 bg-white/90 shadow-sm">
        <CardContent className="space-y-6 p-6">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              <div className="flex size-10 items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800">
                <ServerCog className="size-5 text-gray-600 dark:text-gray-400" />
              </div>
              <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                className="h-9 rounded-xl bg-gray-900 dark:bg-gray-100 dark:text-gray-900 px-4 text-white hover:bg-gray-800 dark:hover:bg-gray-200"
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center gap-3 rounded-xl bg-gray-50 dark:bg-gray-900 px-6 py-10 text-center">
              <ServerCog className="size-8 text-gray-400 dark:text-gray-600" />
              <div className="space-y-1">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">暂无 Sub2API 连接</p>
                <p className="text-sm text-gray-400 dark:text-gray-500">点击「添加连接」保存你的 Sub2API 信息。</p>
              </div>
            </div>
          ) : (
            <div className="space-y-3">
              {servers.map((server) => {
                ...
                return (
                  <div
                    key={server.id}
                    className="flex flex-col gap-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white px-4 py-3"
                  >
                    <div className="flex items-center justify-between gap-3">
                      <div className="min-w-0">
                        <div className="text-sm font-medium text-gray-800 dark:text-gray-200">{server.name || server.base_url}</div>
                      ...
                      <div className="flex items-center gap-1">
                        <button
                          type="button"
                          className="rounded-lg p-2 text-gray-400 dark:text-gray-500 transition hover:bg-gray-100 dark:bg-gray-800 hover:text-gray-700 dark:text-gray-300"
                        ...
                        <button
                          type="button"
                          className="rounded-lg p-2 text-gray-400 dark:text-gray-500 transition hover:bg-rose-50 hover:text-rose-500"
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        variant="outline"
                        className="h-8 rounded-lg border-gray-200 dark:border-gray-700 bg-white px-3 text-xs text-gray-600 dark:text-gray-400"
                    ...
                    {importJob ? (
                      <div className="space-y-2 rounded-xl bg-gray-50 dark:bg-gray-900 px-3 py-3">
                        <div className="text-xs font-medium tracking-[0.16em] text-gray-400 dark:text-gray-500 uppercase">导入任务</div>
                        {(() => {
                          const progress =
                            importJob.total > 0
                              ...
                              : 0;
                          return (
                            <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white px-3 py-3">
                              <div className="flex items-center justify-between gap-3">
                                <div className="min-w-0">
          ...
          <div className="rounded-xl bg-gray-50 dark:bg-gray-900 px-4 py-3 text-sm leading-6 text-gray-500 dark:text-gray-400">
            <p className="font-medium text-gray-600 dark:text-gray-400">使用说明</p>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent showCloseButton={false} className="rounded-2xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300">认证方式</label>
            ...
            <div className="space-y-2">
              ...
              {editingServer ? (
                <div className="flex items-center justify-between gap-2 text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <Button
                    variant="outline"
                    className="h-8 rounded-lg border-gray-200 dark:border-gray-700 bg-white px-2 text-xs text-gray-600 dark:text-gray-400"
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            <div className="max-h-[420px] overflow-auto">
              {pagedAccounts.length === 0 ? (
                <div className="flex items-center justify-center py-12 text-sm text-gray-400 dark:text-gray-500">没有匹配的账号</div>
              ) : (
                <div className="divide-y divide-gray-100 dark:divide-gray-800">
                  {pagedAccounts.map((item) => (
                    <label
                      key={item.id}
                      className="flex cursor-pointer items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:bg-gray-900"
                    >
                      <Checkbox
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          {item.plan_type ? (
                            <Badge className="rounded-md bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400">{item.plan_type}</Badge>
                          ) : null}
                          {item.status ? (
                            <Badge
