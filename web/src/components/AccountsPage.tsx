...
import { AccountImportDialog } from "./accounts/account-import-dialog";
...
const metricCards = [
  { key: "total", label: "账户总数", color: "text-gray-900 dark:text-gray-100", icon: UserRound },
  ...
  { key: "disabled", label: "禁用账户", color: "text-gray-500 dark:text-gray-400", icon: Ban },
    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
      <section className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="space-y-1">
          <div className="text-xs font-semibold tracking-[0.18em] text-gray-500 dark:text-gray-400 uppercase">
            Account Pool
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Button
            variant="outline"
            className="h-10 rounded-xl border-gray-200 dark:border-gray-700 bg-white/80 px-4 text-gray-700 dark:text-gray-300 hover:bg-white"
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Select value={editStatus} onValueChange={(value) => setEditStatus(value as AccountStatus)}>
                <SelectTrigger className="h-11 rounded-xl border-gray-200 dark:border-gray-700 bg-white">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300">额度</label>
              <Input
                value={editQuota}
              ...
              <Card key={item.key} className="rounded-2xl border-white/80 bg-white/90 shadow-sm">
                <CardContent className="p-4">
                  <div className="mb-4 flex items-start justify-between">
                    <span className="text-xs font-medium text-gray-400 dark:text-gray-500">{item.label}</span>
      ...
      <section className="space-y-4">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-3">
            ...
            <Badge variant="secondary" className="rounded-lg bg-gray-200 dark:bg-gray-700 px-2 py-0.5 text-gray-700 dark:text-gray-300">
          ...
          <div className="flex flex-col gap-2 lg:flex-row lg:items-center">
            <div className="relative min-w-[260px]">
              ...
              <Input
                ...
                placeholder="搜索邮箱"
                className="h-10 rounded-xl border-gray-200 dark:border-gray-700 bg-white/85 pl-10"
              />
            </div>
            <Select
              value={typeFilter}
            ...
            >
              <SelectTrigger className="h-10 w-full rounded-xl border-gray-200 dark:border-gray-700 bg-white/85 lg:w-[150px]">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
        ...
        {isLoading && accounts.length === 0 ? (
          <Card className="rounded-2xl border-white/80 bg-white/90 shadow-sm">
            <CardContent className="flex flex-col items-center justify-center gap-3 px-6 py-14 text-center">
              <div className="rounded-xl bg-gray-100 dark:bg-gray-800 p-3 text-gray-500 dark:text-gray-400">
                <LoaderCircle className="size-5 animate-spin" />
              </div>
              <div className="space-y-1">
                <p className="text-sm font-medium text-gray-700 dark:text-gray-300">正在加载账户</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">从后端同步账号列表和状态。</p>
              </div>
            </CardContent>
          </Card>
        ) : null}
        ...
        >
          <CardContent className="space-y-0 p-0">
            <div className="flex flex-col gap-3 border-b border-gray-100 dark:border-gray-800 px-4 py-3 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex flex-wrap items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                <Button
                  variant="ghost"
                  className="h-8 rounded-lg px-3 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:bg-gray-800"
                ...
                {selectedIds.length > 0 ? (
                  <span className="rounded-lg bg-gray-100 dark:bg-gray-800 px-2.5 py-1 text-xs font-medium text-gray-600 dark:text-gray-400">
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[920px] text-left">
                <thead className="border-b border-gray-100 dark:border-gray-800 text-[11px] text-gray-400 dark:text-gray-500 uppercase tracking-[0.18em]">
                  <tr>
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            <span className="font-medium tracking-tight text-gray-700 dark:text-gray-300">
                              {maskToken(account.access_token)}
                            </span>
                            <button
                              type="button"
                              className="rounded-lg p-1 text-gray-400 dark:text-gray-500 transition hover:bg-gray-100 dark:bg-gray-800 hover:text-gray-700 dark:text-gray-300"
                              onClick={() => {
                        ...
                        <td className="px-4 py-3">
                          <Badge variant="secondary" className="rounded-md bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300">
                            {account.type}
                          </Badge>
                        </td>
                        <td className="px-4 py-3">
                        ...
                        <td className="px-4 py-3">
                          <div className="text-xs leading-5 text-gray-500 dark:text-gray-400">{account.email ?? "—"}</div>
                        </td>
                        <td className="px-4 py-3">
                        ...
                        <td className="px-4 py-3 text-gray-500 dark:text-gray-400">{account.success}</td>
                        <td className="px-4 py-3 text-gray-500 dark:text-gray-400">{account.fail}</td>
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-1 text-gray-400 dark:text-gray-500">
                            <button
                              type="button"
                              className="rounded-lg p-2 transition hover:bg-gray-100 dark:bg-gray-800 hover:text-gray-700 dark:text-gray-300"
              ...
              {!isLoading && currentRows.length === 0 ? (
                <div className="flex flex-col items-center justify-center gap-3 px-6 py-14 text-center">
                  ...
                  <div className="space-y-1">
                    <p className="text-sm font-medium text-gray-700 dark:text-gray-300">没有匹配的账户</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">调整筛选条件或搜索关键字后重试。</p>
                  </div>
                </div>
              ) : null}
            </div>
            ...
            <div className="border-t border-gray-100 dark:border-gray-800 px-4 py-4">
              <div className="flex items-center justify-center gap-3 overflow-x-auto whitespace-nowrap">
                ...
                <span className="shrink-0 text-sm leading-none text-gray-500 dark:text-gray-400">
                ...
                >
                  <SelectTrigger className="h-10 w-[108px] shrink-0 rounded-lg border-gray-200 dark:border-gray-700 bg-white text-sm leading-none">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                ...
                <Button
                  variant="outline"
                  size="icon"
                  className="size-10 shrink-0 rounded-lg border-gray-200 dark:border-gray-700 bg-white"
                  disabled={safePage <= 1}
                ...
                {paginationItems.map((item, index) =>
                  item === "..." ? (
                    <span key={`ellipsis-${index}`} className="px-1 text-sm text-gray-400 dark:text-gray-500">
                      ...
                    </span>
                  ) : (
                    <Button
                      ...
                      className={cn(
                        ...
                        item === safePage
                          ...
                          : "border-gray-200 dark:border-gray-700 bg-white text-gray-700 dark:text-gray-300",
                      )}
